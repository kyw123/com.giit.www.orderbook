	...
	<head>
		...
		<script >
			so.init(function(){
				...
				<@test.urlType url="/permission/deletePermissionById.shtml" type="DELETE">
				//全选
			...
			<@test.urlType url="/permission/deletePermissionById.shtml" type="POST">
			<#--根据ID数组删除角色-->
			...
			<@test.urlType url="/permission/addPermission.shtml" type="POST">
			<#--添加权限-->
			function addPermission(){
				...
				var type=$('#type').val();
				if($.trim(type) == ''){
					return layer.msg('权限Type不能为空。',so.default),!1;
				}
				<#--loding-->
				var load = layer.load();
			    ...
			    <div class="modal-content">
			      ...
			      <div class="modal-body">
			        <form id="boxRoleForm">
			          ...
			          <div class="form-group">
			            <label for="recipient-name" class="control-label">请选择请求方式:</label>
