        ...
        <div class="navbar-header">
	     ...
	     <div role="navigation" class="navbar-collapse collapse">
	          ...
	          <ul class="nav navbar-nav" id="topMenu">
				...
				<@shiro.hasAnyRoles name='888888,100003,100002'>
					<li class="dropdown ${(index==3)?string('active','')}">
						...
						<ul class="dropdown-menu">
							<@test.urlType url="/role/index.shtml" type="ALL">
								<li><a href="${basePath}/role/index.shtml">角色列表</a></li>
							</@test.urlType>
							<@test.urlType url="/role/allocation.shtml" type="GET">
								<li><a href="${basePath}/role/allocation.shtml">角色分配</a></li>
							</@test.urlType>
							<@test.urlType url="/permission/index.shtml" type="GET">
								<li><a href="${basePath}/permission/index.shtml">权限列表</a></li>
							</@test.urlType>
							<@test.urlType url="/permission/allocation.shtml" type="GET">
